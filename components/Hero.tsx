    ...
    <section className="relative min-h-screen w-full pt-28 pb-16 flex items-center bg-[#F4F2ED] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-6xl xl:text-7xl font-bold tracking-tight text-[#111111] leading-[1.08] font-heading">
        ...
        >
          {/* Subtle Viewport Badge */}
          <div className="absolute top-4 right-4 z-20 px-3 py-1 rounded-full bg-[#111111]/80 backdrop-blur-md text-[10px] font-mono tracking-widest text-[#F4F2ED] uppercase">
            3D WebGL Viewport
          </div>
